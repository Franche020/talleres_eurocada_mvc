<main class="ubicacion contenedor">
    ...
    <div class="ubicacion--texto">
        <p>Dirección: <span>C/ LONDRES Nº 2-4 Torres de la Alameda Spain</span></p>
        <p>Teléfono: <span>+34 918 85 86 35</span></p>
        <p>Correo: <span>tallereseurocada@yahoo.es</span></p>
    </div>
